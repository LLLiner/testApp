        ...
        */
        ...
        private void setMData()
        {
            ...
            */
            ...
            myConnect.Open();
            MySqlCommand myCmd = new MySqlCommand("SELECT MAX(delay) as maxDelay,MIN(delay) as minDelay FROM time where time>=CURRENT_TIMESTAMP - INTERVAL 5 MINUTE AND upFlag=0;", myConnect);
            MySqlCommand myCmdUp = new MySqlCommand("SELECT MAX(delay) as maxDelay,MIN(delay) as minDelay FROM time where time>=CURRENT_TIMESTAMP - INTERVAL 5 MINUTE AND upFlag=1;", myConnect);
        ...
        private void MainWindows_Load(object sender, EventArgs e)
        {
            ...
            chart.AxisY.Maximum = maxDelay;
            chart.AxisY.Interval = (maxDelay - minDelay) / 20;
            chartA2.AxisY.Minimum = minDelay;
            chartA2.AxisY.Maximum = maxDelay;
            chartA2.AxisY.Interval = (maxDelay - minDelay) / 20;
