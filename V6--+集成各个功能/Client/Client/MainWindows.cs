...
namespace Client
{
    public partial class MainWindows : Form
    {
        ...
        private void btnDO_Click2(object sender, EventArgs e) //谁触发的这个事件，sender就是谁
        {
            ...
            IPAddress temp1 = IPAddress.Parse("192.168.1.200");
            UInt32 srcIp = BitConverter.ToUInt32(temp1.GetAddressBytes(), 0);
            IPAddress temp2 = IPAddress.Parse("192.168.1.233");
            UInt32 dstIp = BitConverter.ToUInt32(temp2.GetAddressBytes(), 0);
        ...
        */
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //使用datatable绑定
            chart1.Series[0].Points.DataBind(dt1.AsEnumerable(), "time", "delay", "");
            ...
            chart1.Series[1].Points.DataBind(dt2.AsEnumerable(), "time", "delay", "");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            chart1.Series[0].Points.DataBind(dt1.AsEnumerable(), "time", "delay", "");
            chart1.Series[1].Points.DataBind(dt2.AsEnumerable(), "time", "delay", "");
            chart1.Series[2].Points.DataBind(dt3.AsEnumerable(), "time", "delay", "");
        }
