        ...
        */
        ...
        private void setMData()
        {
            ...
            */
            ...
            myConnect.Open();
            //MySqlCommand myCmd = new MySqlCommand("SELECT MAX(delay) as maxDelay,MIN(delay) as minDelay FROM time where time>=CURRENT_TIMESTAMP - INTERVAL 1 MINUTE AND upFlag=0;", myConnect);
            //MySqlCommand myCmdUp = new MySqlCommand("SELECT MAX(delay) as maxDelay,MIN(delay) as minDelay FROM time where time>=CURRENT_TIMESTAMP - INTERVAL 1 MINUTE AND upFlag=1;", myConnect);
        ...
        private void MainWindows_Load(object sender, EventArgs e)
        {
            ...
            String dstPort = "10000";
            sendStatus(srcIp, srcPort, dstIp, dstPort, lightP);
            String dstIp2 = "192.168.1.232";
            String dstPort2 = "10000";
            sendStatus(srcIp, srcPort, dstIp2, dstPort2, motorP);
